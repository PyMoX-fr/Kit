...
→ Liste des commandes dont celle pour exécuter la commande **flet run (Rafraîchissement automatique de la page / CLI)**, au besoin re-initialiser soit toutes les libs, soit juste celle de PyMoX.fr pour en avoir la dernière version si necessaire.
...
![Capture rendu de ./start](https://raw.githubusercontent.com/PyMoX-fr/Kit/main/assets/imgs/capture_1.png)
